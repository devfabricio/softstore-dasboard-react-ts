...
const EcommerceOrderColumns = (toggleModal: any): any => [
  {
    text: '',
    dataField: 'id',
    formatter: function formatter (cellContent: any, row: any) {
      return (
  ...
  },
  {
    ...
    sort: true,
    formatter: function formatter (cellContent: any, row: any) {
      return (<Link to="#" className="text-body font-weight-bold">
        {row.orderId}
      </Link>
      )
    }
